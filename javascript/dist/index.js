...
// src/lib/server/serverTransport.js
...
`
  ...
  async handlePostMessage(req, res, parsedBody) {
    ...
    let body;
    try {
      const ct = import_content_type.default.parse(req.headers["content-type"] ? req.headers["content-type"] : "");
      if (ct.type !== "application/json") {
        throw new Error(`Unsupported content-type: ${ct}`);
      }
      body = parsedBody ? parsedBody : await (0, import_raw_body.default)(req, {
...
// src/lib/shared/validators/capabilityValidators.js
var CapabilityValidators = class {
...
var capabilityValidators_default = CapabilityValidators;

// src/lib/shared/helpers/constants.js
var NOTIFICATION_METHOD_NAMES = {
...
var Protocol = class {
  ...
  _onrequest(request) {
    ...
    Promise.resolve().then(() => handler(request, extra)).then(
      (result) => {
  ...
  */
    ...
    return new Promise((resolve, reject) => {
      ...
      if (this._options) {
        if (this._options.enforceStrictCapabilities === true) {
          capabilityValidators_default.assertCapabilityForMethod(request.method, this._clientCapabilities);
        }
      }
      if (options) {
        if (options.signal) {
  ...
  async notification(notification) {
    ...
    capabilityValidators_default.assertNotificationCapability(notification.method, this._capabilities);
  ...
  setRequestHandler(method, handler, validator = (request) => request) {
    capabilityValidators_default.assertRequestHandlerCapability(method, this._capabilities);
    this._requestHandlers.set(
      method,
      (request, extra) => Promise.resolve(handler(validator(request), extra))
    );
  }
  /**
  ...
  setNotificationHandler(method, handler, validator = (notification) => notification) {
    this._notificationHandlers.set(
      method,
      (notification) => Promise.resolve(handler(validator(notification)))
    );
  }
  /**
...
// src/lib/shared/helpers/util.js
...
var Server = class extends protocol_default {
  /**
  ...
  constructor(_serverInfo, options) {
    ...
    this.setRequestHandler(
      REQUEST_METHOD_NAMES.initialize,
      (request) => this._oninitialize(request)
    );
    this.setNotificationHandler(
      NOTIFICATION_METHOD_NAMES.initialized,
      () => {
...
var LATEST_PROTOCOL_VERSION2 = "2024-11-05";
var SUPPORTED_PROTOCOL_VERSIONS2 = ["2024-11-05"];
var Client = class extends Protocol {
  ...
  async connect(transport) {
    ...
    try {
      const result = await this.request(
        {
          method: "initialize",
          params: {
            protocolVersion: LATEST_PROTOCOL_VERSION2,
      ...
      if (!SUPPORTED_PROTOCOL_VERSIONS2.includes(result.protocolVersion)) {
        throw new Error(
